...
function AdminAuction({ snapshot, refresh }: { snapshot: AuctionSnapshot; refresh: () => Promise<void> }) {
  ...
  const [newAuction, setNewAuction] = useState({ name: "Season 5 rehearsal", kind: "demo", purse: "30", base: "1", increment: "0.20", threshold: "5", incrementAbove: "0.50", minSquad: "14", maxSquad: "15" });
